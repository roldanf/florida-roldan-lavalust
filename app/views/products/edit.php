...
<head>
	...
	<style>
		* { box-sizing: border-box; }
		...
		.blob1 { width: 320px; height: 320px; background: #22d3ee; top: -70px; right: -70px; animation: float1 11s ease-in-out infinite; }
		.blob2 { width: 280px; height: 280px; background: #7c3aed; bottom: -70px; left: -50px; animation: float2 13s ease-in-out infinite; }
